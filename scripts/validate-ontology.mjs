...
const officialHosts = [
  ...
  "sc.com", "nic.gov.gh", "bic.co.bw", "nedbank.co.sz", "fnb.co.ls", "esric.co.sz", "lnighollard.co.ls", "bmoi.mg", "tools.assurancesaro.mg", "bcpbank.mu", "mua.mu", "absa.sc", "sacos.sc", "snpsf.com", "amanassurances.com", "standardbank.com.na", "nedbank.com.na", "mozabanco.co.mz", "emose.co.mz",
];
...
if (ontology.records.length < 255) errors.push(`expected at least 255 records, found ${ontology.records.length}`);
