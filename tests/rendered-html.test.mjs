...
test("ships a sourced worldwide banking, insurance, and UN ontology", async () => {
  ...
  const fullyCovered = [
    ...
    "Kuwait", "Qatar", "Bahrain", "Oman", "Ethiopia", "Djibouti",
    "Fiji", "Samoa", "Tonga", "Papua New Guinea", "Solomon Islands", "Vanuatu",
    "Panama", "Belize", "Cuba", "Guyana", "Suriname", "Trinidad and Tobago", "Nicaragua",
    ...
    "Bangladesh", "Nepal", "Sri Lanka", "Pakistan", "Maldives",
    ...
    "Ukraine", "Myanmar", "Libya", "Sudan", "South Sudan",
    "Afghanistan", "Somalia", "Syria", "Yemen",
    "Bhutan", "Micronesia", "Kiribati",
    "Global",
  ];
